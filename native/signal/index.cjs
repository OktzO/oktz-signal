...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./signal.wasi.cjs', false, ['./signal.wasm32-wasi.debug.wasm', './signal.wasm32-wasi.wasm'])
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        wasiBinding = require('./signal.wasi.cjs')
...
module.exports.curveGenerateKeypair = nativeBinding.curveGenerateKeypair
module.exports.curveScalarMultiply = nativeBinding.curveScalarMultiply
module.exports.curveSign = nativeBinding.curveSign
module.exports.curveVerify = nativeBinding.curveVerify
module.exports.protoDecodePkmsg = nativeBinding.protoDecodePkmsg
module.exports.protoDecodeWhisper = nativeBinding.protoDecodeWhisper
module.exports.protoEncodePkmsg = nativeBinding.protoEncodePkmsg
module.exports.protoEncodeWhisper = nativeBinding.protoEncodeWhisper
module.exports.ratchetDecryptPkmsg = nativeBinding.ratchetDecryptPkmsg
module.exports.ratchetDecryptWhisper = nativeBinding.ratchetDecryptWhisper
module.exports.ratchetEncrypt = nativeBinding.ratchetEncrypt
module.exports.sessionDeserialize = nativeBinding.sessionDeserialize
module.exports.sessionHaveOpenSession = nativeBinding.sessionHaveOpenSession
